...
@Component({
  ...
  template: `
    ...
    <section id="tools" class="space-y-6 py-8 md:py-12 lg:py-24">
      ...
      <div
        class="mx-auto grid justify-center gap-4 sm:grid-cols-2 md:max-w-[64rem]"
      >
        <a routerLink="/stack" hlmCard class="group">
          <div hlmCardHeader>
            ...
            <p hlmCardDescription>
              Opinionated full-stack based on Supabase, Angular, tRPC, Tailwind,
              AnalogJs, Nx and Drizzle.
            </p>
          </div>
        </a>
        ...
        <a routerLink="/documentation/installation" hlmCard class="group">
          <div hlmCardHeader>
            ...
            <p hlmCardDescription>
              Accessible, composable UI primitives that come styled or unstyled.
            </p>
          </div>
        </a>
      </div>
