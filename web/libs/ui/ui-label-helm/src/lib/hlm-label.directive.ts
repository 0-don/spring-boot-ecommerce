...
export class HlmLabelDirective {
  public readonly _brn = inject(BrnLabelDirective, { host: true });
  ...
  public readonly _variant = signal<LabelVariants['variant']>('default');
  @Input()
  set variant(value: LabelVariants['variant']) {
    this._variant.set(value);
  }

  public readonly _error = signal<LabelVariants['error']>('auto');
  @Input()
